...
export const ICONS_LECTURES = [
  {
    ...
    flipFrontLive: "Now showing your clearly defined goal.",
    flipBackHint: " to show my goal",
    cardSection: "Your goal card",
    cardLabel: "My clearly defined goal",
    cardPlaceholder: "e.g. Earn $10,000/month from my business",
    emptyHint: "Tap edit to write your goal",
    modalTitle: "Set your clearly defined goal",
    saveLabel: "Save goal",
    beginDayLead: "Set your goal to begin",
    cardAriaFront: "Goal card showing your goal. Tap to flip.",
    modalIntro:
  ...
  },
  {
    ...
    flipFrontLive: "Now showing your new identity.",
    flipBackHint: " to show my identity",
    cardSection: "Your identity card",
    cardLabel: "My new identity is...",
    cardPlaceholder: "e.g. I am the beloved. I walk as a child of the Most High.",
    emptyHint: "Tap edit to write your new identity",
    modalTitle: "Set your new identity",
    saveLabel: "Save identity",
    beginDayLead: "Set your identity to begin",
    cardAriaFront: "Identity card showing your new identity. Tap to flip.",
    modalIntro:
      "This walk resets identity. Write who you are becoming. Walk or sit still, receive the declarations, then speak them for 30 days.",
    completeText:
  ...
  },
  {
    ...
    flipFrontLive: "Now showing the desire already yours.",
    flipBackHint: " to show my desire",
    cardSection: "Your desire card",
    cardLabel: "The desire already mine is...",
    cardPlaceholder: "e.g. $10,000 a month already in my hands",
    emptyHint: "Tap edit to write the desire already yours",
    modalTitle: "Name the desire already yours",
    saveLabel: "Save desire",
    beginDayLead: "Set your desire to begin",
    cardAriaFront: "Desire card showing the desire already yours. Tap to flip.",
    modalIntro:
      "This session creates one desire in the present. Sit alone in a quiet room. Write that one thing as already here. Listen daily for 30 days.",
    completeText:
