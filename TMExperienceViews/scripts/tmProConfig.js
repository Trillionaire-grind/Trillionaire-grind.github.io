...
export const TM_PRO_CHECKOUT_ENABLED = false;

export const TM_PRO_BENEFITS = [
  "Speech recordings (up to 2 per month)",
  "Personal speaker reel page to share with your club",
];
