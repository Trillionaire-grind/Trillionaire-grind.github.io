...
const STRINGS = {
  ht: {
    ...
    "book.noChapters": "Liv sa a poko gen chapit pou li. Nou ap ajoute kontni a.",
    "book.readPdf": "Louvri PDF la",
    "auth.signupTestTitle": "Tès sèlman",
    "auth.signupTestBody":
      "Kreye yon kont se pou tès pou kounye a — bibliyotèk la ap grandi. Ou bezwen yon kòd aksè valab (apre acha pè a).",
    "auth.signupTestContinue": "Kontinye",
    "library.empty": "Pa gen liv pibliye nan bibliyotèk la ankò.",
    ...
    "pass.videoHint": "Videyo prezantasyon an poko pare — paj sa a di sa klèman. Achte pè $10 la pou debloke bibliyotèk Kreyòl la.",
    ...
    "pass.devBypassHint": "Panèl tès la disponib sèlman sou localhost / 127.0.0.1 — pa sou sit an pwodiksyon.",
  ...
  fr: {
    ...
    "book.noChapters": "Ce livre n’a pas encore de chapitres à lire. Le contenu arrive bientôt.",
    "book.readPdf": "Ouvrir le PDF",
    "auth.signupTestTitle": "Test uniquement",
    "auth.signupTestBody":
      "La création de compte est en mode test pour l’instant — la bibliothèque grandit encore. Il vous faut un code d’accès valide (après achat du pass).",
    "auth.signupTestContinue": "Continuer",
    "library.empty": "Aucun livre publié dans la bibliothèque pour le moment.",
    ...
    "pass.videoHint": "La vidéo de présentation n’est pas encore prête — ceci est un espace réservé honnête. Votre pass à 10 $ débloque la bibliothèque en créole.",
    ...
    "pass.devBypassHint": "L’UI de contournement n’est disponible que sur localhost / 127.0.0.1 — pas sur le site en production.",
  ...
  es: {
    ...
    "book.noChapters": "Este libro aún no tiene capítulos para leer. Pronto añadiremos el contenido.",
    "book.readPdf": "Abrir PDF",
    "auth.signupTestTitle": "Solo prueba",
    "auth.signupTestBody":
      "Crear cuenta es solo para pruebas por ahora — la biblioteca aún crece. Necesitas un código de acceso válido (después de comprar el pase).",
    "auth.signupTestContinue": "Continuar",
    "library.empty": "Todavía no hay libros publicados en la biblioteca.",
    ...
    "pass.videoHint": "El video de presentación aún no está listo — este es un espacio reservado honesto. Tu pase de $10 desbloquea la biblioteca en criollo.",
    ...
    "pass.devBypassHint": "La UI de bypass solo está en localhost / 127.0.0.1 — no en el sitio en producción.",
  ...
  en: {
    ...
    "book.noChapters": "This book does not have chapters to read yet. Content is being added.",
    "book.readPdf": "Open PDF",
    "auth.signupTestTitle": "Test only",
    "auth.signupTestBody":
      "Account creation is for testing right now — the library is still growing. You need a valid access code (after buying a pass).",
    "auth.signupTestContinue": "Continue",
    "library.empty": "No published books in the library yet.",
    ...
    "pass.videoHint": "Intro video is not ready yet — this is an honest placeholder. Your $10 pass unlocks the Kreyòl library.",
    ...
    "pass.devBypassHint": "Dev bypass UI is localhost / 127.0.0.1 only — not on the live site.",
