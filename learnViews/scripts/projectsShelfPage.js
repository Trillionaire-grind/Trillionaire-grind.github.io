...
export function initProjectsShelf(root) {
  ...
  root.innerHTML = `
    <p class="shelf-lead">
      Work I have shipped: products, client sites, and Haiti work. Read more for what it does and the tech behind it. Open a product to use it.
    </p>
    <div class="shelf-filters" id="shelfFilters" role="tablist" aria-label="Product type"></div>
    ...
    <div class="shelf-modal" id="shelfModal" aria-hidden="true">
      ...
      <div class="shelf-modal-panel" role="dialog" aria-modal="true" aria-labelledby="shelfModalTitle">
        ...
        <button type="button" class="shelf-modal-cta" id="shelfModalOpen">Open product</button>
      </div>
    </div>`;
