...
export const OFFERS = [
  ...
  },
  {
    ...
    note: "15 to 30 min call to discuss your book idea and next steps",
    visual: {
      kind: "cover",
  ...
  },
  {
    ...
    note: "15 to 30 min call to see if we're a fit. No commitment.",
  ...
  },
  {
    ...
    subtitle: "From $97 to $xB. Your question is the job.",
    leads: [
      "My job is sometimes to be the person who shows you how to use Google, how to use AI agents, and how to get unstuck when you forget. That ranges from changing the background on your home screen to building the next billion-dollar unicorn.",
    ],
    bullets: [
      "Starts at $97. Grows with the job, up to $xB",
      "Google, AI agents, phone settings, business questions, products, companies",
      "When you forget or hit a wall, you come back. That is the work",
    ],
    actions: [
      { label: "See how help works", href: "/consultingViews/help.html", external: true, primary: true },
      { label: "Book a time", nav: "speak", primary: false },
    ],
  ...
  },
  {
    ...
    leads: [
      "Liv Lakay was built to support the mission of providing education to the youth of Haiti by making education more accessible. Primary education is every child's right. Access to books and materials is still a barrier for too many students.",
