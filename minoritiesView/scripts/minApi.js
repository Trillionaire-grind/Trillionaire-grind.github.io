/**
 * Client helpers for The Minorities Cloud Functions.
...
export async function createSubscriptionCheckout(tierId, idToken, options) {
  ...
  return postJson(
    ...
    {
      tierId,
      successPath: (options && options.successPath) || "/minorities.html",
      cancelPath: (options && options.cancelPath) || "/minorities.html#subscribe",
    },
    idToken,
  );
}
...
export async function createBillingPortal(idToken, options) {
  ...
  return postJson(
    ...
    {
      returnPath: (options && options.returnPath) || "/minorities.html#subscribe",
    },
    idToken,
  );
}
